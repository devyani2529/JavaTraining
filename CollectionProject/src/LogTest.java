...
public class LogTest {
	public static void main(String[] args) {
		...
		Log log1 = new Log("INFO",LocalDateTime.now(),"Devyani","File uploaded");
		Log log2 = new Log("WARN",LocalDateTime.now(),"Devyani","File uploaded");
		Log log3 = new Log("ERR",LocalDateTime.now(),"Devyani","File uploaded");
		Log log4 = new Log("DEBUG",LocalDateTime.now(),"Devyani","File uploaded");
		Log log5 = new Log("FATAL",LocalDateTime.now(),"Devyani","File uploaded");
